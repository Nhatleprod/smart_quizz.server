...
function initModels(sequelize) {
  ...
  accounts.belongsToMany(group_study, {
    as: "groupId_group_studies",
    through: group_members,
    foreignKey: "accountId",
    otherKey: "groupId",
  });
  group_study.belongsToMany(accounts, {
    as: "accountId_accounts",
    through: group_members,
    foreignKey: "groupId",
    otherKey: "accountId",
  });
  ...
  accounts.hasMany(exam_attempts, {
    as: "exam_attempts",
    foreignKey: "accountId",
  });
  ...
  refresh_tokens.belongsTo(accounts, {
    as: "account",
    foreignKey: "accountId",
  });
  accounts.hasMany(refresh_tokens, {
    as: "refresh_tokens",
    foreignKey: "accountId",
  });
  exam_attempt_details.belongsTo(answers, {
    as: "answer",
    foreignKey: "answerId",
  });
  answers.hasMany(exam_attempt_details, {
    as: "exam_attempt_details",
    foreignKey: "answerId",
  });
  exam_attempt_details.belongsTo(exam_attempts, {
    as: "examAttempt",
    foreignKey: "examAttemptId",
  });
  exam_attempts.hasMany(exam_attempt_details, {
    as: "exam_attempt_details",
    foreignKey: "examAttemptId",
  });
